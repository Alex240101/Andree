...
export default function InscripcionSantaAnitaPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    paquete: "",
    metodoPago: "",
    horario: "", // Agregando selección de horario
  })

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    if (!formData.nombreCompleto || !formData.paquete || !formData.metodoPago || !formData.horario) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#7a1034]/20 to-[#5a1428]/30">
      {/* Header */}
      <section className="bg-[#7a1034] text-white py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            ...
            <p className="text-xl">Canchas Sport Plaza - Frente al Mall</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-card/95 rounded-lg shadow-xl p-8">
            <div className="flex items-center mb-8">
              <div className="w-16 h-16 relative mr-4">
                <Image src="/images/logo.jpg" alt="Master Sport FC" fill className="object-contain rounded-full" />
              </div>
              <div>
                <h2 className="text-2xl font-bold text-foreground">Master Sport FC</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="nombreCompleto" className="text-foreground">
                    Nombre Completo *
                  </Label>
                  <Input
                    id="nombreCompleto"
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-foreground">Selecciona tu Horario</h3>
                <RadioGroup
                ...
                >
                  <div className="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-muted/50">
                    <RadioGroupItem value="martes-jueves" id="martes-jueves" />
                    <Label htmlFor="martes-jueves" className="flex-1 cursor-pointer text-foreground">
                      <div className="font-medium">Martes y Jueves</div>
                      <div className="text-sm text-muted-foreground">9:00 PM - 11:00 PM</div>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-muted/50">
                    <RadioGroupItem value="lunes-miercoles" id="lunes-miercoles" />
                    <Label htmlFor="lunes-miercoles" className="flex-1 cursor-pointer text-foreground">
                      <div className="font-medium">Lunes y Miércoles</div>
                      <div className="text-sm text-muted-foreground">8:00 PM - 9:00 PM</div>
                    </Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-xl font-bold text-foreground">Selecciona tu Paquete</h3>
                <RadioGroup
                      ...
                      <Label htmlFor={pkg.id} className="flex-1 cursor-pointer">
                        <div className="flex justify-between items-center">
                          ...
                          <div className="text-right">
                            <span className="text-2xl font-bold text-yellow-400">S/ {pkg.price}</span>
              ...
              <div className="space-y-4">
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-bold text-foreground">Método de Pago</h3>
                </div>
                ...
                >
                  <div className="flex items-center space-x-3 p-4 border border-border rounded-lg hover:bg-muted/50">
                    ...
                    <Label htmlFor="yape" className="flex items-center cursor-pointer">
                      ...
                      <span className="font-medium text-foreground">Yape</span>
                    </Label>
                  </div>
              ...
              <Button
                type="submit"
                size="lg"
                className="w-full text-lg bg-yellow-400 hover:bg-yellow-500 text-[#7a1034] font-bold"
              >
                Continuar al Pago
              </Button>
            </form>
